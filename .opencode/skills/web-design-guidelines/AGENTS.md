...
- SHOULD: Placeholders end with an ellipsis and show example pattern
...
- SHOULD: Use an ellipsis character for options opening follow-ups (e.g., Rename) and loading states (e.g., Loading)
...
- MUST: Use a single ellipsis glyph (not three dots)
